package fr.unilasalle.flight.api.fisa.resources;

import fr.unilasalle.flight.api.fisa.beans.Avion;
import fr.unilasalle.flight.api.fisa.repositories.AvionRepository;
...
public class AvionResource extends GenericResource {
    ...
    public Response getPlaneById(@PathParam("id") Long id) {
        Avion plane = repository.findByIdOptional(id).orElse(null);
    ...
    public Response createPlane(Avion avion) {
        ...
        try {
            ...
            return Response.serverError().entity(
                    new ErrorWrapper("Erreur lors de l'enregistrement"))
                    .build();
        }
    }
